    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-nav transition-all duration-300">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-2 group cursor-pointer">
          <div className="w-10 h-10 bg-gradient-to-tr from-brand-primary to-brand-secondary rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
        ...
        <button className="relative p-2 rounded-full hover:bg-gray-100/50 transition-colors duration-200 group">
          <FiShoppingCart size={24} className="text-gray-700 group-hover:text-brand-primary transition-colors" />
